...
module.exports = {
  intro: {
    en: "From our founding to today’s multi-industry ecosystem, each milestone shows how Nam Viet grows — through technology, infrastructure and people — for stronger agriculture.",
    vi: "Từ ngày thành lập đến hệ sinh thái đa ngành hôm nay, mỗi cột mốc cho thấy cách Nam Việt phát triển: bằng công nghệ, hạ tầng và con người — vì nông nghiệp vững chắc hơn.",
    zh: "从创立到今日的多产业生态，每一个里程碑都说明南越如何成长——依靠技术、基础设施与人才，建设更强的农业。",
  },
  items: [
    {
      year: "2002",
  ...
  banner: {
    file: "banner.jpg",
    statement: {
      en: "The journey continues — for agriculture that lasts and prospers.",
      vi: "Hành trình còn tiếp tục — vì nông nghiệp bền vững và thịnh vượng.",
      zh: "旅程仍在继续——为了可持续且繁荣的农业。",
    },
    stats: [
      {
        icon: "years",
