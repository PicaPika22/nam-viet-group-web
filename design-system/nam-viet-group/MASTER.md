...
> Next, check `design-system/patterns/` for reusable **ADN** (Design DNA) modules.
> If neither applies, strictly follow the rules below.
>
> **ADN index:** [`../ADN.md`](../ADN.md)

---

**Project:** Nam Viet Group
**Generated:** 2026-07-29 20:47:14
**Category:** B2B Service / Industrial conglomerate (navy · Kim Metal)
**Design Dials:** Variance 3/10 (Centered / Minimal) | Motion 5/10 (Standard) | Density 5/10 (Standard)

### Active ADN modules

| ID | Path |
|----|------|
| `adn.vertical-people-panels` | `design-system/patterns/vertical-people-panels.md` |
| `adn.page.leadership` | `design-system/pages/leadership.md` |
